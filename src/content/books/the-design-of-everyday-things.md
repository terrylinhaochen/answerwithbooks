...
author: Don Norman
year: 1988
oneLiner: "Norman’s distinctive mechanism is the action loop: usable design closes the gap between human goals and system behavior by making possible actions, control relationships, constraints, and feedback perceptible."
readIf: "Read this if users keep choosing the wrong control on a stove, appliance panel, or software screen you are redesigning."
...
1. Could the user tell what actions were possible?
2. Could the user connect the intended result to the right control?
3. Could the user perform the action without unnecessary precision or memory?
4. Could the user perceive and interpret what changed?
5. Could the user tell whether the goal had been achieved?
